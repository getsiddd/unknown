...
void EEPROM_WEIGHTX::write_function_mode(int function_mode){
	eeprom_write_byte((uint8_t *) LOCATION_FUNCTION_MODE, function_mode);
	function = function_mode;
}

uint8_t EEPROM_WEIGHTX::read_function_mode(){
	return eeprom_read_byte((uint8_t *)LOCATION_FUNCTION_MODE);
}